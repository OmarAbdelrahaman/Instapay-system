...
public class OrangeApi extends PaymentApi {
  private static ArrayList<WalletAccount> accounts = new ArrayList<>();

  public OrangeApi() {
    if (accounts.isEmpty()) {
      accounts.add(new WalletAccount("01200000000", 100));
      accounts.add(new WalletAccount("01200000001", 200));
      accounts.add(new WalletAccount("01200000002", 300));
    }
  }
