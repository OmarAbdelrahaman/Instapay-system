...
public class HsbcApi extends PaymentApi {

  private static ArrayList<BankAccount> accounts = new ArrayList<>();

  public HsbcApi() {
    if (accounts.isEmpty()) {
      accounts.add(new BankAccount(11111111, "1234567890123456", "1234", "01501112226", 1000));
      accounts.add(new BankAccount(22222222, "1234567890123457", "1234", "01501112227", 2000));
      accounts.add(new BankAccount(33333333, "1234567890123458", "1234", "01501112228", 3000));
      accounts.add(new BankAccount(44444444, "1234567890123459", "1234", "01501112229", 4000));
    }
  }
